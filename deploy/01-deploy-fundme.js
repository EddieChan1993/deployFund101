...
const {devChains, networkConfig, END_CD, SEPOLIA_CHAINID} = require("../hardhat.helper.config")
...
module.exports = async ({getNamedAccounts, deployments}) => {
    ...
    if (hre.network.config.chainId == SEPOLIA_CHAINID && process.env.ETHERSCAN_API_KEY) {
